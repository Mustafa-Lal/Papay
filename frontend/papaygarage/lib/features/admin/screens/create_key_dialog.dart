  ...
  class _CreateKeyDialogState extends State<CreateKeyDialog> with SingleTickerProviderStateMixin {
    ...
    Widget build(BuildContext context) {
      ...
      // Never let the dialog get wider than the screen allows, with a small
      // side margin so it doesn't touch the edges on narrow devices.
      final double horizontalMargin = isMobile ? 32 : 80;
      final double dialogWidth =
          (screenSize.width - horizontalMargin).clamp(0, _dialogMaxWidth).toDouble();
