...
Future<void> printMechanicInvoice(
  BuildContext context,
  MechanicInvoice invoice,
) async {
  ...
  final invoiceNumber =
      '${DateFormat('yyMMdd').format(invoice.invoiceDate)}-${invoice.id.toString().padLeft(3, '0')}';
  final dateStr = DateFormat('dd/MM/yyyy').format(invoice.invoiceDate);
...
// ── Items Table ───────────────────────────────────────────────────────────────
pw.Widget _itemsTable(MechanicInvoice invoice, pw.Font arFont, pw.Font arBold) {
