...
const _accentSoft = Color(0xFFF5EAD4);
    ...
    final saveButton = ElevatedButton.icon(
      ...
      style: ElevatedButton.styleFrom(
        ...
        padding: EdgeInsets.symmetric(
            horizontal: 24, vertical: isMobile ? 16 : 20),
        textStyle: const TextStyle(fontSize: 14.5, fontWeight: FontWeight.w700),
      ).copyWith(
        backgroundColor: WidgetStateProperty.resolveWith((states) {
          if (states.contains(WidgetState.disabled)) return _accent.withValues(alpha: 0.5);
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: const Row(
          ...
          children: [
            Icon(Icons.add, size: 16, color: _accentDark),
            SizedBox(width: 6),
            Text(
              'Add Item',
              style: TextStyle(
  ...
  Widget build(BuildContext context) {
    return RichText(
      text: TextSpan(
        ...
        children: [
          if (required)
            const TextSpan(text: ' *', style: TextStyle(color: _accent)),
          if (hint != null)
            TextSpan(
              text: ' $hint',
...
class _accentInput extends StatelessWidget {
