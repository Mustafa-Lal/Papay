...
from app.services.mechanic_invoice_update import (
    update_mechanic_invoice,
)


class MechanicInvoiceUpdateTests(unittest.TestCase):
    ...
    def test_update_can_be_rolled_back(self):
        with Session(engine) as db:
            ...
            # Commit creation first.
            # The rollback below must only undo the update.
            db.commit()
