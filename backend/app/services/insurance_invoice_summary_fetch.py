...
def get_insurance_customers(
    ...
    # --------------------------------------------------
    # Count matching invoice/customer records
    # --------------------------------------------------
    ...
    # --------------------------------------------------
    # Fetch customers + invoice summary
    #
    # One result = one invoice.
    # This is intentional because pagination is based
    # on invoices, not customers.
    # --------------------------------------------------
...
def get_insurance_customers_this_month(
    db: Session,
    limit: int = 10,
    offset: int = 0,
) -> dict:
